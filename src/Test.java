 ...
 * se temelji na usporeðivanju output datoteka.
...
public class Test {
	...
	public static final int BR_NAJVISEG_TESTA = 25;	
	public static final String prvi_dio = "C:\\Users\\Murta\\Desktop\\lab3_primjeri\\test";
	public static final String ulazni = "\\primjer.in";  //naziv ulaznog filea, paziti na nastavak
	public static final String njihov_izlaz = "\\primjer.out"; //naziv njihovog rezultata, paziti na ekstenziju
	public static final String moj_izlaz = "\\test_labosa.out";	//ovo može ostat isto
	...
	public static void main(String[] args) throws Exception {
		...
		for(int i = 1; i <= BR_NAJVISEG_TESTA; i++){
			...
			argsum[0] = ""+i;
			try{
				SimHash.main(argsum);	//POZIVANJE main PROGRAMA KOJI RADITE
										//šalje se broj testa kao argument komandne linije za unutrašnje
										//debuggiranje ako netko želi tako
			}
			catch(NullPointerException e){
				System.setOut(original);
				System.out.println("Test broj "+ i +" baca NullPointerException.");
			...
			//ovdje poèinje engine usporedbe
			s = prvi_dio+broj+moj_izlaz;		
			file=new File(s);
